...
def send_text(message):
    ...
    if current == 'контакты':
        ...
        if back[0] == 'наша продукция' and len(back) == 1:
            bot.send_message(message.chat.id, 'Выберите нужный режим', reply_markup=keyboard1)
            back.remove('наша продукция')
        elif back[1] == 'мебель для спальни' and len(back) == 2:
            bot.send_message(message.chat.id, 'Выберите вид мебели', reply_markup=keyboard2)
            back.remove('мебель для спальни')
        elif back[1] == 'мебель для гостинной' and len(back) == 2:
            bot.send_message(message.chat.id, 'Выберите вид мебели', reply_markup=keyboard2)
            back.remove('мебель для гостинной')
        elif back[len(back)-1] == 'розалина':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('розалина')
        elif back[len(back)-1] == 'мармарис':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('мармарис')
        elif back[len(back)-1] == 'анна':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('анна')
        elif back[len(back)-1] == 'элегант люкс':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('элегант люкс')
        elif back[len(back)-1] == 'александра':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('александра')
        elif back[len(back)-1] == 'сенатор':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('сенатор')
        elif back[len(back)-1] == 'изабелла 4':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('изабелла 4')
        elif back[len(back)-1] == 'изабелла 6':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('изабелла 6')
        elif back[len(back)-1] == '0101':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('0101')
        elif back[len(back)-1] == '0102':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('0102')
        elif back[len(back)-1] == '0103':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('0103')
        elif back[len(back)-1] == '0104':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard3)
            back.remove('0104')
        elif back[len(back)-1] == 'пенал 8069':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard4)
            back.remove('пенал 8069')
        elif back[len(back)-1] == 'пенал 8070':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard4)
            back.remove('пенал 8070')
        elif back[len(back)-1] == 'горка 8069':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard4)
            back.remove('горка 8069')
        elif back[len(back)-1] == 'стенка афродита':
            bot.send_message(message.chat.id, 'Выберите нужную модель', reply_markup=keyboard4)
            back.remove('стенка афродита')
        ...
        bot.send_message(message.chat.id,'Перейдите по ссылке: https://www.google.com/maps/place/GRANT+FUTURES+MEBEL/@41.2481259,69.1636308,254a,35y,39.24t/data=!3m1!1e3!4m5!3m4!1s0x38ae891a6a7927c1:0xc2971cdaabfe7bc0!8m2!3d41.2499708!4d69.1645316')
    elif current == 'камея':
